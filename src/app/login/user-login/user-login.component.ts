...
export class UserLoginComponent implements OnInit {
  ...
  constructor(private router:Router,private loginService:LoginService,private student:StudentService,private snackbar: MatSnackBar) { }
  ...
  login(){
    ...
    (data : any) => {
      ...
      if(data.status){
        ...
        this.student.getUserRoleDetails(data.result.result.userId).subscribe(
          (data:any)=>{
        ...
        if(sessionStorage.getItem('usertype') != '6' && sessionStorage.getItem('usertype') != '5'){
